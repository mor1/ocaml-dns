...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4a030c00fbdcd330936cb9a155a79be1) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns_server"; "Dns_resolver"];
                      lib_pack = false;
                      lib_internal_modules = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("lwt.unix",
                               Some (OASISVersion.VGreaterEqual "2.4.1"));
                   ...
                   {
                      lib_modules = ["Dns_server_unix"; "Dns_resolver_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\152Ñ\011\131~\128v\015^ía#c©¤Ø";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
